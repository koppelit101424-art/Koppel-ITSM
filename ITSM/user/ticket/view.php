...
$sql = "SELECT 
        ...
        LEFT JOIN ticket_ratings r ON t.ticket_id = r.ticket_id
        WHERE t.ticket_id = ?";
...
<div class="tab-pane fade" id="chatTab">
    ...
    <form id="chatForm" action="?ajax=send_message">
        ...
        <textarea id="chatMessage" name="chatMessage" class="form-control " rows="3" required placeholder="Type your message..."></textarea>
...
if(closeBtn){
    closeBtn.addEventListener('click', function(){
        ...
        fetch('?ajax=update_ticket_status', {
            method: 'POST',
            headers: {'Content-Type':'application/x-www-form-urlencoded'},
            body: new URLSearchParams({
                ticket_id: <?= $ticket_id ?>,
