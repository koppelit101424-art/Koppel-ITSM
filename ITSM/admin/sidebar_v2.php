...
$inventory_pages = array_merge($asset_pages, [
...
<!-- ASSETS -->
<a data-title="Assets" class="dropdown-btn <?= in_array($page,$asset_pages) ? 'active' : '' ?>">
<i class="bi bi-list"></i>
<span class="menu-text">Assets</span>
<i class="bi bi-chevron-down ms-auto dropdown-arrow"></i>
</a>

<div class="submenu <?= in_array($page,$asset_pages) ? 'show' : '' ?>">
