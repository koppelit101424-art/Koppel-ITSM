...
<div class="card shadow-sm mb-4">
  <div class="card-header bg-white d-flex justify-content-between align-items-center">
    <h6 class="mb-0 fw-semibold">
      <i class="fas fa-filter me-1"></i> Issuance Filter
    </h6>
  ...
  <div class="card-body">
    ...
    <div class="card shadow-sm rounded-3 mb-4">
      <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom-0">
          <h5 class="mb-0 fw-semibold">Issuance Record</h5> </div>
                            ...
                            <tr data-transaction="<?= $row['transaction_id'] ?>"  
                                ...
                                <?php 
                                    if (empty($row['date_returned']) || $row['date_returned'] == '0000-00-00 00:00:00') 
                                        echo '<span class="status-issued">Not Returned</span>';
                                    else 
...
function printInventory() {
    ...
    let html = `
    <h2 style="text-align:center;">Tablet Issuance Report</h2>
