    ...
    $(document).ready(function () {
        ...
        $('#usersTable tbody').on('contextmenu', 'tr', function (e) {
            ...
            $('#editUserLink').attr('href',
                '?page=organization/crud/edit_user&user_id=' + encodeURIComponent(selectedUserId)
            ...
            $('#deleteUserLink').off('click').on('click', function (e) {
                ...
                if (confirm('Are you sure you want to delete ' + userName + '?')) {
                    window.location.href =
                        '?page=organization/crud/delete_user&user_id=' + encodeURIComponent(selectedUserId);
                }
