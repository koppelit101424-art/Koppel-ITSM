                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="Proceed Request" <?= ($request['status'] ?? '') === 'Proceed Request' ? 'selected' : '' ?>>
                                Proceed Request
                            </option>
                            <option value="On Stock" <?= ($request['status'] ?? '') === 'On Stock' ? 'selected' : '' ?>>
                                On Stock
                            </option>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input
                            ...
                            name="quantity"
                            class="form-control"
                            value="<?= htmlspecialchars($request['quantity'] ?? 1) ?>"
                            min="1">
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="date_needed"
                            value="<?= isset($request['date_needed']) ? date('Y-m-d', strtotime($request['date_needed'])) : '' ?>"
                            required>
                    </div>
                </div>
