...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("
        ...
        (ticket_number, user_id, fullname, email, company, department,
         ...
         subject, subject_details, issue, status, assigned_to)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '$status', $assigned_to)
    ");
...
<link rel="stylesheet" href="<?= BASE_URL ?>/user/asset/css/main.css">
<link rel="stylesheet" href="<?= BASE_URL ?>/user/asset/css/menu.css">
</head>
...
<input class="form-control" value="<?= $ticket_number ?>" readonly>
</div>
...
<input type="hidden" name="impact" value="None">
