    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="text-primary">Asset Management System</h2>


        <div class="d-flex align-items-center">
            <div class="search-box me-3">
                <input type="text" placeholder="Search..." class="form-control" id="globalSearch">
            </div>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                    <li>
                        <a class="dropdown-item d-flex align-items-center"  href="profile/edit.php">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center text-danger" href="logout.php" onclick="return confirm('Are you sure you want to log out?');">
