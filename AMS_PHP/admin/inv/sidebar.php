...
<div class="sidebar col-md-2" id="sidebar" style="height: 100vh; width: 250px;">
    ...
    <a href="index.php" class="<?= $currentDir === 'index' ? 'active' : '' ?>">
        <i class="fas fa-server"></i>
        <span class="sidebar-text">Dashboard</span>
    </a>
    <!-- Inventory (toggle parent) -->
    <a href="inventory.php" id="inventory-toggle" style="cursor: pointer;">
    ...
    <div id="tickets-submenu" class="submenu-container <?= $isTicketSection ? '' : 'collapsed' ?>">
        ...
        <a href="../assigned_tickets.php" class="<?= $currentPage === 'assigned_tickets.php' && $currentDir === 'ticket' ? 'active' : '' ?>" style="padding-left:2.5rem !important;">
            <i class="fas fa-user-check"></i>
            <span class="sidebar-text">Assigned Tickets</span>
        </a>
        <a href="../sla.php" class="<?= $currentPage === 'sla.php' && $currentDir === 'ticket' ? 'active' : '' ?>" style="padding-left:2.5rem !important;">
            <i class="fas fa-clock"></i>
            <span class="sidebar-text">SLA</span>
        </a>
        <a href="../sla_settings.php" class="<?= $currentPage === 'sla_settings.php' && $currentDir === 'ticket' ? 'active' : '' ?>" style="padding-left:2.5rem !important;">
