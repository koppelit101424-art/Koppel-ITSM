...
<div class="sidebar col-md-2" id="sidebar" style="height: 100vh; width: 250px;">
    ...
    <a href="index.php" id="inventory-toggle" style="cursor: pointer;" class="<?= ($currentPage === 'index.php' && $currentDir === 'index') ? 'active' : '' ?>">
    ...
    <a href="users.php" class="<?= ($currentPage === 'users.php' && $currentDir === 'users') ? 'active' : '' ?>">
        <i class="fas fa-user-tie"></i>
        <span class="sidebar-text">Users</span>
    </a>
        <a href="tickets.php" class="<?= ($currentPage === 'tickets.php' && $currentDir === 'tickets') ? 'active' : '' ?>">
        <i class="fas fa-ticket"></i>
        <span class="sidebar-text">Tickets</span>
    </a>
    <a href="requests.php"  class="<?= ($currentPage === 'requests.php' && $currentDir === 'requests') ? 'active' : '' ?>">
        <i class="fas fa-file-alt"></i>
        <span class="sidebar-text">Requests</span>
    </a>

    <a href="transactions.php"  class="<?= ($currentPage === 'transactions.php' && $currentDir === 'transactions') ? 'active' : '' ?>">
        <i class="fas fa-file-invoice-dollar"></i>
        <span class="sidebar-text">Transactions</span>
    </a>
    <a href="reports.php" class="<?= ($currentPage === 'reports.php' && $currentDir === 'reports') ? 'active' : '' ?>">
        <i class="fas fa-chart-line"></i>
        <span class="sidebar-text">Reports</span>
    </a>
    <a href="settings.php" class="<?= ($currentPage === 'settings.php' && $currentDir === 'settings') ? 'active' : '' ?>">
