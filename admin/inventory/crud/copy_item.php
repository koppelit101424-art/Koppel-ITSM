...
if (isset($_GET['copy_item'])) {

    $itemId = (int)$_GET['copy_item'];
...
<div class="main-content" id="mainContent">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" class="mt-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="name" class="form-control" value="<?= htmlspecialchars($copy['name'] ?? '') ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Brand</label>
                        <input type="text" name="brand" class="form-control" value="<?= htmlspecialchars($copy['brand'] ?? '') ?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="model" class="form-control" value="<?= htmlspecialchars($copy['model'] ?? '') ?>"required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mb-3" id="pcSpecsFields" style="display:none;">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="cpu" class="form-control" value="<?= htmlspecialchars($copy['cpu'] ?? '') ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">RAM</label>
                        <input type="text" name="ram" class="form-control" value="<?= htmlspecialchars($copy['ram'] ?? '') ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">ROM</label>
                        <input type="text" name="rom" class="form-control" value="<?= htmlspecialchars($copy['rom'] ?? '') ?>">
                    </div>
                    <div class="col-md-3 ">
                        <label class="form-label">Motherboard</label>
                        <input type="text" name="motherboard" class="form-control" value="<?= htmlspecialchars($copy['motherboard'] ?? '') ?>">
                    </div>
                    <div class="col-md-3 mt-3">
                        <label class="form-label">Operating System</label>
                        <input type="text" name="os" class="form-control" value="<?= htmlspecialchars($copy['os'] ?? '') ?>">
                    </div>
                    <div class="col-md-3 mt-3">
                        <label class="form-label">OS Key</label>
                        <input type="text" name="key" class="form-control"value="<?= htmlspecialchars($copy['key'] ?? '') ?>">
                    </div>
                    <div class="col-md-3 mt-3">
                        <label class="form-label">Antivirus</label>
                        <input type="text" name="antivirus" class="form-control" value="<?= htmlspecialchars($copy['antivirus'] ?? '') ?>">
                    </div>
                    <div class="col-md-3 mt-3">
                        <label class="form-label">Computer Name</label>
                        <input type="text" name="comp_name" class="form-control" value="<?= htmlspecialchars($copy['comp_name'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    name="description"
                    class="form-control"
                    rows="6"><?= htmlspecialchars($copy['description'] ?? '') ?></textarea>
                                    </div>

                <div class="row mb-3">
                    <div class="col-md-4">
                        <label class="form-label">Quantity</label>
                        <input type="number" name="quantity" class="form-control" value="<?= htmlspecialchars($copy['quantity'] ?? '') ?>" required>
                    </div>
                    <div class="col-md-4">
            ...
            name="date_received"
            class="form-control"
            value="<?= htmlspecialchars($copy['date_received'] ?? date('Y-m-d')) ?>"
            required>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="type_id" class="form-control" required>
                            ...
                            <?php if ($type_result->num_rows > 0): ?>
                                <?php while($type = $type_result->fetch_assoc()): ?>
                                    <option
                                        value="<?= $type['type_id'] ?>"
                                        <?= (($copy['type_id'] ?? '') == $type['type_id']) ? 'selected' : '' ?>>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function togglePcSpecs() {
            const value = itemInput.value.trim().toLowerCase();

            if (
                value.includes("laptop") ||
                value.includes("system unit") ||
        ...
        itemInput.addEventListener("input", togglePcSpecs);
