...
const searchMap = [
    ...
    // Inventory sub-items
    { label: 'Desktops', keywords: ['desktop', 'desktops'], url: '../desktop/desktop.php' },
                { label: 'Add Desktop', keywords: ['desktop', 'desktops', 'add desktop'], url: '../../inv/desktop/add_desktop.php' },
    { label: 'Laptops', keywords: ['laptop', 'laptops'], url: '../laptop/laptop.php' },
    { label: 'Printers', keywords: ['printer', 'printers'], url: '../printer/printer.php' },
    { label: 'IP Phones', keywords: ['ip phone', 'ip phones', 'phone'], url: '../ip_phone/ip_phone.php' },
    { label: 'Biometrics', keywords: ['biometric', 'biometrics', 'fingerprint'], url: '../biometrics/biometrics.php' },
