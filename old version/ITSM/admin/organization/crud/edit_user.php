        ...
        <form method="POST" action="">
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" name="emp_id" id="emp_id" class="form-control" value="<?= htmlspecialchars($user['emp_id']) ?>" required>
          ...
          <button type="submit" id="saveBtn" class="btn btn-primary"> Update User</button>
