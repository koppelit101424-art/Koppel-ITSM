      ...
      if (isset($_POST['cred_id']) && !empty($_POST['cred_id'])) {
          ...
          if ($stmt->execute()) {
            //   $message = '<div class="alert alert-success">Credential updated successfully!</div>';
                    echo "<script>
            window.location.href='?page=inventory/credentials&msg=" . urlencode("Credential added successfully! Code: $item_code") . "';
        </script>";
          } else {
      ...
      <div class="card">
          ...
          <div class="card-body">
              ...
              <form method="POST" class="mt-3">
                  ...
                  <button type="submit" class="btn btn-primary" >Save Credential
                  </button>
