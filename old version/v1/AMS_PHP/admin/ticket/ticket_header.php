...
const searchMap = [
    ...
    { label: 'Users', keywords: ['users', 'user list'], url: '../user/users.php' },
    ...
    { label: 'Assigned Tickets', keywords: ['ticket', 'tickets', 'assigned'], url: 'assigned_tickets.php' },
    { label: 'SLA', keywords: ['ticket', 'tickets', 'sla'], url: 'sla.php' },
    { label: 'SLA Settings', keywords: ['ticket', 'tickets', 'sla settings'], url: 'sla_settings.php' },
