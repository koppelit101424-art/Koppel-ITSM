...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        header("Location: ../index.php?msg=Item updated successfully! Code: $item_code");
        exit();
    } else {
      ...
      <form method="POST" class="mt-3">
        <div class="row mb-3">
          <div class="col-md-4">
            ...
            <input type="text" id="item_code" class="form-control" value="<?= htmlspecialchars($item['item_code']) ?>" readonly>
          </div>
