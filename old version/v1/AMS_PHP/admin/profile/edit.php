...
$sql = "SELECT emp_id, fullname, position, email, department, company, area, date_hired 
...
<link rel="icon" href="../../asset/img/Koppel.ico">
                    ...
                    <form method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="date_hired"
